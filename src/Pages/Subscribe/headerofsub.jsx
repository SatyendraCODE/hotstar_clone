      ...
      <MDBContainer className="p-0 pt-3">
          ...
          >
            <defs>
              <radialGradient
                ...
                fx="98.305%"
                fy="99.794%"
                gradientTransform="matrix(.36145 0 0 1 .628 0)"
              >
        ...
        <MDBCollapse navbar show={showBasic}>
          ...
          <MDBDropdown>
            <MDBDropdownToggle
              tag="a"
              className="nav-link bord text-white me-4 dropdown-sub-header-lang"
              role="button"
            >
              <span>View in </span>English
            </MDBDropdownToggle>
            <MDBDropdownMenu className="bg-tr">
              <MDBDropdownItem link className="bg-tr-a">
                हिंदी
              </MDBDropdownItem>
              <MDBDropdownItem link className="bg-tr-a">
                தமிழ்
